...
class BreakoutBoltOrchestrator:
    ...
    def market_is_open(self) -> bool:
        ...
        if now.weekday() >= 5:
            return False
        return self.settings.market_open_hour_et <= now.hour < self.settings.market_close_hour_et
    ...
    async def scan_once(self) -> dict:
        ...
        # Exit processing — fetch all open-position snapshots in parallel.
        ...
        # Signal scan — fetch all watchlist snapshots in parallel.
